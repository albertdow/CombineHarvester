...
combineTool.py -m 125 -M MultiDimFit --setParameters muV=1,alpha=0,muggH=1,mutautau=1 --setParameterRanges alpha=-90,90 --setParameterRanges muV=1,5 --setParameterRanges muggH=-1,2 --redefineSignalPOIs alpha -d output/$1/$2/125/ws.root --algo none --robustFit 1 --there -n .robustFit.bestfit --cminDefaultMinimizerStrategy=0 --saveFitResult
